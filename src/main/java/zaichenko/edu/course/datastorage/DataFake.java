...
public class DataFake {
    ...
    private List<Teacher> teachers = new LinkedList<>(
            Arrays.asList(
                    new Teacher("Viktor", "Stepanov","teacher","+380964536863",10),
                    new Teacher("Vlad", "Zaichenko","teacher","+380975173862",6),
    ...
    private List<Group> groups = new LinkedList<>(
            Arrays.asList(
                    ...
                    new Group("group 2", "Software Engineering","FIT","description",20),
                    new Group("group 3", "Computer Science","FIT","description",15)
            )
    );
